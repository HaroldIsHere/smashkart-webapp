    ...
    <body>
        <div class="header">
            ...
            <div class="categories_tab">
                ...
                <a href="{{ route('products.productLibrary', ['category' => 'shoes']) }}"
                    class="category-option">Shoes</a>
        ...
        <div class="product-container">
            ...
            <div class="product-options">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" id="quantity" name="quantity" value="1" min="1" max="{{ $bag->Stock }}"
                ...
                <button class="add-to-cart-btn" onclick="addToCart('bag', {{ $bag->BagID }})" type="button">Add to
                    Cart</button>
            </div>
                        ...
                        <div class="bag-card">
                            ...
                            @if($bag->RC)
                                <span class="badge" style="cursor:pointer;"
                                    ...
                                    <img src="/img/Icons/RC.png" alt="RC"
                            ...
                            @if($bag->SC)
                                <span class="badge" style="cursor:pointer;"
                                    ...
                                    <img src="/img/Icons/SC.png" alt="SC"
                                        style="width:20px; height:20px; vertical-align:middle;">
                                </span>
                            @endif
