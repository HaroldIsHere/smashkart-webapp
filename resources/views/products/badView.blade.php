<DOCTYPE html>
    ...
    <body>
        ...
        <div class="product-container">
            <img src="{{ asset('/img/Products/Rackets/' . $bad->Name . '.jpg') }}" alt="Racket Image"
                class="product-image">
            <div class="product-options">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" id="quantity" name="quantity" value="1" min="1" max="{{ $bad->Stock }}"
        ...
        <div class="onsale">
            ...
            <div class="slider-container">
                @foreach($bads as $badItem)
                    <a href="{{ route('products.badView', ['name' => $badItem->Name]) }}"
                        style="text-decoration:none; color:inherit;">
                        <div class="bag-card">
                            <img src="{{ asset('img/Products/Rackets/' . $badItem->Name . '.jpg') }}"
                                alt="{{ $badItem->Name }}"
