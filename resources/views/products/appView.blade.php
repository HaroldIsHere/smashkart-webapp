...
<body>
    ...
    <div class="product-container">
        <img src="{{ asset('/img/Products/Apparel/' . $apparel->Name . '.jpg') }}" alt="Apparel Image"
            class="product-image">
        <div class="product-options">
            ...
            <div class="quantity-selector">
                ...
                <input type="number" id="quantity" name="quantity" value="1" min="1" max="{{ $apparel->Stock }}"
    ...
    <div class="onsale">
        ...
        <div class="slider-container">
            @foreach($apparels as $item)
                <a href="{{ route('products.appView', ['name' => $item->Name]) }}"
                    style="text-decoration:none; color:inherit;">
                    <div class="bag-card">
                        <img src="{{ asset('img/Products/Apparel/' . $item->Name . '.jpg') }}" alt="{{ $item->Name }}"
