...
<html>
    ...
    <div class="categories_tab">
        ...
        <div class="product-container">
            <img src="{{ asset('/img/Products/Apparel/' . $apparel->Name . '.jpg') }}" alt="Apparel Image" class="product-image">
            <div class="product-options">
                ...
                <div class="quantity-selector">
                    ...
                    <input type="number" id="quantity" name="quantity" value="1" min="1" max="{{ $apparel->Stock }}" class="quantity-input" readonly>
                    <button type="button" class="quantity-btn" onclick="changeQuantity(1)">+</button>
                </div>
                <script>
                ...
                <button class="add-to-cart-btn"
                    onclick="addToCart('apparel', {{ $apparel->AppID }}, document.getElementById('quantity').value)">
                    Add to Cart
                </button>
            </div>
            <div class="product-details">
                <h2>Description</h2>
                <p>{{ $apparel->Description ?? 'No description available.' }}</p>
        ...
        <div class="onsale">
            ...
            <div class="slider-container">
                ...
                <a href="{{ route('products.appView', ['name' => $item->Name]) }}" style="text-decoration:none; color:inherit;">
                    <div class="bag-card">
                        <img src="{{ asset('img/Products/Apparel/' . $item->Name . '.jpg') }}" alt="{{ $item->Name }}" style="width:100%; height:150px; object-fit:cover; border-radius:8px;">
                        <h3>{{ $item->Name }}</h3>
