    ...
    <div class="product-container">
        ...
        <div class="product-options">
            ...
            <div class="quantity-selector">
                ...
                <input type="number" id="quantity" name="quantity" value="1" min="1" max="{{ $shoe->Stock }}"
            ...
            <button class="add-to-cart-btn"
                onclick="addToCart('shoe', {{ $shoe->ShoeID }}, document.getElementById('quantity').value)">
                Add to Cart
            </button>
        </div>
    ...
    <div class="onsale">
        ...
        <div class="slider-container">
            @foreach($shoes as $item)
                <a href="{{ route('products.shoeView', ['name' => $item->Name]) }}"
                    style="text-decoration:none; color:inherit;">
                    <div class="bag-card">
                        <img src="{{ asset('img/Products/Shoes/' . $item->Name . '.jpg') }}" alt="{{ $item->Name }}"
