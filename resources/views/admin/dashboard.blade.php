...
@media (max-width: 1200px) {
    ...
    .dashboard-card, .dashboard-main .dashboard-card {
        min-width: 0;
        width: 100%;
    }
}
@media (max-width: 700px) {
    .dashboard-wrapper, .pending-orders-table-container {
        padding: 12px 2px;
    }
    .dashboard-card, .dashboard-main .dashboard-card, .pending-orders-table-container {
    ...
    <div class="dashboard-main">
        ...
        <div class="dashboard-card">
            ...
            <form id="salesFilterForm" style="margin-bottom: 12px;">
                ...
                <input type="month" id="salesMonth" name="salesMonth" value="{{ request('salesMonth', now()->format('Y-m')) }}">
            </form>
