                    ...
                    @foreach(session('cart') as $item)
                        ...
                        <tr>
                            <td>
                                ...
                                @endphp
                                <img src="{{ $imageUrl }}" alt="{{ $item['name'] }}" class="cart-product-img" width="50"
                                    onerror="this.style.display='none'; this.insertAdjacentHTML('afterend', '<span>No Image</span>');">
                            </td>
                            <td>{{ $item['name'] }}</td>
                            <td>₱{{ number_format($item['price'], 2) }}</td>
                            <td>
                                <input type="number" min="1" class="quantity-input" data-name="{{ $item['name'] }}"
                                    value="{{ $item['quantity'] }}"
